...
### добавляем правило в  pam которые при подключении пользователя по ssh  будет запускать созданный нами скрипт. таким образом мы мыжем настроить жополнительные факторы для доступа на машину
